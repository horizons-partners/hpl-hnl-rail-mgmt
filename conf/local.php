 ...
 * Run for user: hpl_admin
 * Date: Fri, 16 Oct 2020 15:12:50 +0000
 */

$conf['title'] = 'Honolulu Rail - Management';
$conf['start'] = 'main';
...
$conf['disableactions'] = 'register,resendpwd,profile_delete,source,export_raw';
$conf['htmlok'] = 1;
...
$conf['canonical'] = 1;
$conf['autoplural'] = 1;
$conf['plugin']['cleanup']['mediaatticage'] = 60*60*24*30*3;
$conf['plugin']['imagebox']['default_caption_style'] = 'Bold';
$conf['plugin']['pdfjs']['hide_download_button'] = 1;
$conf['plugin']['googleanalytics']['GAID'] = 'UA-169331445-1';
$conf['plugin']['googleanalytics']['anonymize'] = 0;
...
$conf['tpl']['bootstrap3']['landingPages'] = '(main)';
...
$conf['tpl']['bootstrap3']['pageInfo'] = 'extension,date,locked';
$conf['tpl']['bootstrap3']['pageIcons'] = 'feed,send-mail,permalink,print,help';
